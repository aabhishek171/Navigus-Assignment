<?php
    ...
    $query = "SELECT `question_number`,`question`,`question_image` FROM `questions` WHERE `subject`=`$subject`";
...
<div class="container" style="margin-top: 20px; ">
    ...
    <form id="quizForm" action="handlers/quiz_handler.php" method="POST" name="quizForm">
